const API_URL = "https://excessive-efficient-rifle.glitch.me/";
...
const phoneValidateOption = {
  format: {
    ...
    message:
      'Номер телефона должен соответсветсвовать фомату: "+8(XXX)XXX-XX-XX"',
  },
};
...
form.addEventListener("submit", async (event) => {
  ...
  try {
    ...
    if (response.ok) {
      prompt(
        "Открытка успешно сохранена. Доступна по адрессу: ",
